    ...
    <div v-if="showModal" class="fixed inset-0 flex items-center justify-center bg-opacity-50 p-4 backdrop-blur-xs">
      <div class="bg-white p-8 rounded-lg shadow-lg max-w-2xl w-full">
        ...
        <div class="flex justify-end space-x-2 mt-4">
          <button @click="copyToClipboard" class="bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600">Copy
          </button>
          <button @click="exportTxt" class="bg-purple-500 text-white px-4 py-2 rounded-lg hover:bg-purple-600">Export
          </button>
          <button @click="showModal = false" class="bg-gray-500 text-white px-4 py-2 rounded-lg hover:bg-gray-600">
            Close
          </button>
        </div>
      </div>
