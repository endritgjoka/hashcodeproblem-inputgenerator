...
<template>
  <div class="relative min-h-screen bg-gray-900 overflow-x-hidden font-sans">
    ...
    <div class="flex flex-col items-center justify-center p-4 sm:p-6 min-h-screen">
      ...
      <div class="flex items-center space-x-6 w-full max-w-5xl justify-center">
          ...
          <fieldset class="space-y-1">
            <form @submit.prevent="handleFormSubmit" id="generation-form" ref="formRef" novalidate>
              ...
              <div class="flex flex-col sm:flex-row sm:space-x-4 space-y-3 sm:space-y-0">
                <div class="flex-1">
                  <label for="numBooks"
                    class="block text-gray-300 font-semibold mb-1 text-sm sm:text-base">Books</label>
                  <input :disabled="isLoading" id="numBooks" ref="numBooksRef" v-model.number="numBooks"
                    ...
                    @blur="checkCrossFieldValidity('numBooks')" type="number" min="1" max="1000000" required class="w-full p-2 bg-gray-700 border border-gray-600 text-gray-100 rounded-lg placeholder-gray-400 disabled:opacity-50
                ...
                <div class="flex-1">
                  <label for="numLibraries"
                    class="block text-gray-300 font-semibold mb-1 text-sm sm:text-base">Libraries</label>
                  <input :disabled="isLoading" id="numLibraries" v-model.number="numLibraries" @input="markAsCustom"
                    type="number" min="1" max="2500" required class="w-full p-2 bg-gray-700 border border-gray-600 text-gray-100 rounded-lg placeholder-gray-400 disabled:opacity-50
                                  focus:ring focus:ring-green-500 focus:border-green-500
                                  invalid:border-red-500 invalid:ring-red-500 invalid:text-red-400" />
                  <div class="h-3"></div>
                </div>
                <div class="flex-1">
                  ...
                  <input :disabled="isLoading" id="numDays" v-model.number="numDays" @input="markAsCustom" type="number"
                    min="1" max="2000" required class="w-full p-2 bg-gray-700 border border-gray-600 text-gray-100 rounded-lg placeholder-gray-400 disabled:opacity-50
                                  focus:ring focus:ring-green-500 focus:border-green-500
                                  invalid:border-red-500 invalid:ring-red-500 invalid:text-red-400" />
                  <div class="h-3"></div>
                </div>
              ...
              <div class="flex flex-col sm:flex-row sm:space-x-4 space-y-3 sm:space-y-0 mt-3">
                ...
                <div class="flex-1">
                  <label class="block text-gray-300 font-semibold mb-1 text-sm sm:text-base">Books Per Library
                    Range</label>
                  <div class="flex space-x-2">
                    <input :disabled="isLoading" id="booksPerLibraryMin" ref="booksPerLibraryMinRef"
                      ...
                      min="1" max="10000" class="w-1/2 p-2 bg-gray-700 border border-gray-600 text-gray-100 rounded-lg placeholder-gray-400 disabled:opacity-50
                                      focus:ring focus:ring-green-500 focus:border-green-500
                                      invalid:border-red-500 invalid:ring-red-500 invalid:text-red-400" />
              ...
              <div class="flex flex-col sm:flex-row sm:space-x-4 space-y-3 sm:space-y-0 mt-3">
                <div class="flex-1">
                  ...
                  <div class="flex space-x-2">
                    <input :disabled="isLoading" id="signupTimeMin" ref="signupTimeMinRef"
                      ...
                      max="50" class="w-1/2 p-2 bg-gray-700 border border-gray-600 text-gray-100 rounded-lg placeholder-gray-400 disabled:opacity-50
                                      focus:ring focus:ring-green-500 focus:border-green-500
                                      invalid:border-red-500 invalid:ring-red-500 invalid:text-red-400" />
                ...
                <div class="flex-1">
                  <label class="block text-gray-300 font-semibold mb-1 text-sm sm:text-base">Books Shipped / Day
                    Range</label>
                  <div class="flex space-x-2">
                    <input :disabled="isLoading" id="booksPerDayMin" ref="booksPerDayMinRef"
                      ...
                      max="2500" class="w-1/2 p-2 bg-gray-700 border border-gray-600 text-gray-100 rounded-lg placeholder-gray-400 disabled:opacity-50
                                      focus:ring focus:ring-green-500 focus:border-green-500
                                      invalid:border-red-500 invalid:ring-red-500 invalid:text-red-400" />
    ...
    <div v-if="showModal"
      ...
      <div class="relative bg-gray-800 p-6 rounded-lg shadow-xl max-w-2xl w-full border border-gray-700 flex flex-col"
        ...
        <div class="flex justify-end space-x-3 flex-shrink-0">
          ...
          <button @click="exportTxt" title="Export as .txt"
...
.presets-scrollbar::-webkit-scrollbar-track { background: #4a5568; border-radius: 4px; }
.output-scrollbar::-webkit-scrollbar-thumb,
.presets-scrollbar::-webkit-scrollbar-thumb { background-color: #718096; border-radius: 4px; border: 2px solid #4a5568; }
.output-scrollbar::-webkit-scrollbar-thumb:hover,
.presets-scrollbar::-webkit-scrollbar-thumb:hover { background-color: #a0aec0; }
pre.output-scrollbar,
div.presets-scrollbar { scrollbar-width: thin; scrollbar-color: #718096 #4a5568; }
